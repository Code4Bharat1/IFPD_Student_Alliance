...
const GetinTouch = () => {
  ...
  return (
    <>
      ...
      <section className="min-h-screen w-full bg-gradient-to-br from-bg-section via-purple-50 to-pink-50 py-16 px-4">
        <div className="max-w-7xl mx-auto">
          {/* Header Section */}
          <div className="text-center mb-16 animate-fadeInDown">
            <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-brand-primary via-purple-600 to-pink-600 bg-clip-text text-transparent mb-4">
              Let's Connect
            </h1>
            <p className="text-text-secondary text-lg md:text-xl max-w-2xl mx-auto text-black">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative group">
                  ...
                  <div className="relative">
                    <div
                      className={`absolute left-4 top-1/2 -translate-y-1/2 transition-colors ${
                        focusedField === "mobile" ? "text-purple-600" : "text-gray-400"
                      }`}
                    >
                      <svg
                        className="w-5 h-5"
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 hover:from-purple-700 hover:via-pink-700 hover:to-purple-700 text-white font-bold py-4 px-8 rounded-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center gap-3"
                >
                  {isSubmitting ? (
                    <>
            ...
            <div className="space-y-8 animate-fadeInRight">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {/* Location Card */}
                <div className="bg-gradient-to-br from-purple-600 to-pink-600 rounded-2xl p-6 text-white shadow-xl hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/90 text-sm leading-relaxed">
                      Our support team is always here to assist you. Feel free
